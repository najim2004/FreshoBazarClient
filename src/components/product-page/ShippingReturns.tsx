...
export const ShippingReturns: React.FC = () => {
  ...
  if (isLoading) {
    return <ShippingReturnsSkeleton />;
  }

  return (
    <Card className="mt-8 rounded-b-md border-none rounded-t-none shadow-sm overflow-hidden">
...
const ShippingReturnsSkeleton: React.FC = () => {
  return (
